...
\begin{center}
\Large \textbf{- Erarbeitung von prozentualen Anteilen -} \\
\end{center} 
...
\end{minipage}%   
 ...
 \begin{align*}
& a) \;\; 0,06=   	\qquad\qquad\qquad\qquad\,	&&b) \;\; 0,96=    \qquad\qquad\qquad\qquad\;\;	&&c) \;\; 0,7  =      \qquad\qquad\qquad\qquad \\
& d) \;\; \frac{1}{4}=     	\qquad\qquad\qquad\;\;\;\;\;\,	&&e) \;\; \frac{17}{20} =    \qquad\qquad\qquad\quad\,	&&f) \;\; \frac{3}{5}=    \qquad\qquad\qquad\qquad \\
& g) \;\; 0,6541 =   	\qquad\qquad\qquad\quad  	&&h) \;\; 7  =   \qquad\qquad\qquad\quad\;	&&i) \;\; \frac{11}{9}  = \qquad\qquad\qquad\qquad  
\end{align*} 
...
\hfill 
\begin{minipage}{0.95\textwidth}
\textbf{Aufgabe 2:} Gib die Zahlen in der gekürzten Bruch- und Dezimalzahldarstellung an.
\end{minipage}%   


 \begin{align*}
& a) \;\; 30\%=   	\qquad\qquad\qquad\qquad\qquad\quad\;\;	&&b) \;\; 6,25\%=    \\ &&& \\
&c) \;\; 44,\bar{4}\%  =  \qquad\qquad\qquad\qquad\qquad\quad\;\;	&&d) \;\; 125\%  =    \qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad  \qquad\qquad\qquad\qquad  
\end{align*} 
...
\hfill 
\begin{minipage}{0.89\textwidth}
\textbf{Aufgabe 4:} Beantworte die Fragen und beschreibe die Auffälligkeit.
\end{minipage}%   



 \begin{align*}
 &a) \;\;  \begin{array}{l} \text{Wie viel sind $10\%$ von $50$?}  \\ \text{Wie viel sind $50\%$ von $10$?}   \end{array} \qquad 
&&b) \;\;  \begin{array}{l} \text{Wie viel sind $17\%$ von $100$?}  \\ \text{Wie viel sind $100\%$ von $17$?}   \end{array}  \\  &&& \\
 &c) \;\;  \begin{array}{l} \text{Wie viel sind $8\%$ von $25$?}  \\ \text{Wie viel sind $25\%$ von $8$?}   \end{array}  \qquad 
&&d) \;\;  \begin{array}{l} \text{Wie viel sind $7\%$ von $800$?}  \\ \text{Wie viel sind $800\%$ von $7$?}   \end{array}    \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad 
\end{align*} 
\vspace{1em}
...
\hfill 
\begin{minipage}{0.89\textwidth}
\textbf{Aufgabe 5:} Beantworte die Fragen und beschreibe die Auffälligkeit.
\end{minipage}%   



$a)\; \begin{array}{l} \text{Wie viel sind $\frac{1}{2}$ von $100$?} \\ \text{Wie viel sind $\frac{1}{2}$ von $50$?}  \\  \text{Wie viel sind $\frac{1}{2}$ von $\frac{1}{2}$ von $100$?}  \end{array}$ \qquad \qquad  $b)\; \begin{array}{l} \text{Wie viel sind $30\%$ von $100$?} \\ \text{Wie viel sind $50\%$ von $30$?}  \\  \text{Wie viel sind $30\%$ von $50\%$ von $100$?}  \end{array}$   \\

\vspace{0.8em}

$c)\; \begin{array}{l} \text{Wie viel sind $75\%$ von $100\%$?} \\ \text{Wie viel sind $66,\bar{6}\%$ von $75\%$?}  \\  \text{Wie viel sind $20\%$ von $50\%$?} \\  \text{Wie viel sind $75\%$ von $66,\bar{6}\%$ von $20\%$ von $100\%$?}  \end{array}$  \\
...
\hfill 
\begin{minipage}{0.89\textwidth}
\textbf{Aufgabe 6:} Fülle die Lücken im Lückentext so aus, dass die beiden Aussagen zusammen stimmen.
\end{minipage}%   

 
\vspace{1em}
		
$a)\;\;$ Ein ganzer Kreis hat $360^\circ$, somit hat ein Sechstel Kreis $\fib{100000}$.  \\
$b)\;\;$ $180^\circ$ bei einem Kreis entsprechen $50\%$ vom Kreis. $\fib{100000}$ entsprechen $1\%$ von einem Kreis.   \\
$c)\;\;$ $2000$\EUR{} entsprechen $100\%$, dann entsprechen $\fib{100000}$ $1\%$.   \\
$d)\;\;$ Wenn $400\,$m als $20\%$ verstanden werden, dann sind $\fib{100000}$ als $100\%$ zu verstehen.  \\		
...
\hfill 
\begin{minipage}{0.89\textwidth}
\textbf{Aufgabe 7:} Fülle die Lücken im Lückentext so aus, dass die Aussage auf die Skizze zu trifft.
\end{minipage}%   
...
$40\%$ vom Rechteck sind $\fib{100000}$ markiert. $25\%$ vom Rechteck sind $\fib{100000}$ markiert. $\fib{100000}$ vom Rechteck sind rot und blau markiert.
...
$25\%$ vom Rechteck sind $\fib{100000}$ markiert. $66,\bar{6}\%$ vom Rechteck sind $\fib{100000}$ markiert. $\fib{100000}$ von den blau markierten sind auch rot markiert, also sind $\fib{100000}$ vom Rechteck rot und blau markiert.
...
\hfill 
\begin{minipage}{0.89\textwidth}
\textbf{Aufgabe 8:} Bei einer Umfrage gaben $16,7\%$ der Personen die Antwort $G$, $8,3\%$ die Antwort $K$,  $37,5\%$ die Antwort $F$,  $25\%$ die Antwort $B$ und  $9,7\%$ die Antwort $N$ an. Gib an, welches Kreisdiagramm den Sachzusammenhang richtig darstellt und begründe, warum die anderen beiden Optionen nicht richtig sein können.
\end{minipage}%   
...
\hfill 
\begin{minipage}{0.95\textwidth}
\textbf{Aufgabe 9:} Lies die Behauptungen zum Diagramm zur Darstellung einer Wahl im Vergleich zur letzten Wahl und kreuze wahr, falsch oder nicht bestimmbar an. Begründe deine Wahl. 
\end{minipage}%   
...
\end{center}
    ...
    $2016$ hat die Partei $B$ mehr als doppelt so    &    &     &     		 \\  
     viele Stimmen wie die Partei $C$ bekommen.  &    &     &     		 \\ \hline
    Die Partei $A$ bekam $2020$ mehr Stimmen als $2016$.   &    &     &     		 \\ \hline
     $2020$  hat die Partei $A$ weniger Stimmen als   &    &     &     		 \\  
     die Parteien $B$ und $C$ zusammen bekommen.  &    &     &     		 \\ \hline
    Die Wahlen scheinen den Zahlen nach gültig zu sein.   &    &     &     		 \\ \hline 
    \end{tabular}
